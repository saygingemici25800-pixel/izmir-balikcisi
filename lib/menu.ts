export type MenuItem = {
  name: string;
  price?: string; // omitted for market-priced items (see `daily`)
  unit?: string;
  daily?: boolean; // fresh fish sold by weight — daily market price, ask staff
  desc: string;
  tags?: string[];
  img?: string;
...
export const MENU: MenuCategory[] = [
  {
    id: 'mezeler',
    title: 'Mezeler',
    subtitle: 'Soğuk ve sıcak başlangıçlar — sabit fiyat, porsiyon',
    items: [
      {
      ...
      { name: 'Kalamar Tava',   price: '320', unit: '₺', desc: 'Çıtır kaplı, jiletle dilimlenmiş halkalar, tartar sosu.',         tags: ['sıcak', 'kızartma'] },
    ],
  },
  {
    id: 'corbalar',
    title: 'Çorbalar',
    subtitle: 'Sıcak başlangıçlar, günün balığından — sabit fiyat',
    items: [
      { name: 'Balık Çorbası',  price: '160', unit: '₺', desc: 'Günün balığı, sebze suyu, ince doğranmış kereviz, limon.', tags: ['sıcak'] },
      { name: 'Karides Bisque', price: '180', unit: '₺', desc: 'Karides kabuğundan çekilmiş krema, taraçon esintisi.',     tags: ['sıcak'] },
    ],
  },
  {
    id: 'izgaralar',
    title: 'Izgara Balıklar',
    subtitle: 'Açık ateşte, bütün balık — günlük fiyat, kiloyla. Fiyat için sorunuz.',
    items: [
      {
        name: 'Çupra Izgara',
        daily: true,
      ...
      { name: 'Levrek Izgara',   daily: true, desc: 'Bütün levrek, zeytinyağı, biberiye.',               tags: ['ızgara', 'bütün'] },
      { name: 'Lüfer Pırasayla', daily: true, desc: 'Mevsiminde lüfer, közlenmiş pırasa, limon.',         tags: ['ızgara', 'mevsim'] },
      { name: 'Palamut Izgara',  daily: true, desc: 'Mevsim palamutu, tuzlanmış limon, soğan piyazı.',     tags: ['ızgara', 'mevsim'] },
    ],
  },
  {
    id: 'bugulama',
    title: 'Buğulama & Fırın',
    subtitle: 'Bütün balık; kâğıtta ve tuzda — günlük fiyat, kiloyla. Fiyat için sorunuz.',
    items: [
      {
      ...
      { name: 'Çupra Tuzda Pişmiş', daily: true, desc: 'Bütün çupra, deniz tuzu kabuğunda, masada açılır.', tags: ['fırın', 'bütün'] },
      { name: 'Levrek Sebze Üstü',  daily: true, desc: 'Pırasa, kabak, havuç yatağında fırında, bütün.',     tags: ['fırın'] },
    ],
  },
  {
    id: 'tava',
    title: 'Tava & Kızartma',
    subtitle: 'Çıtır kaplama, Ege üslubu — porsiyon, sabit fiyat',
    items: [
      {
        name: 'Hamsi Tava',
        price: '280',
      ...
      },
      {
        ...
        tags: ['kızartma', 'mevsim'],
        img: 'https://images.unsplash.com/photo-1485921325833-c519f76c4927?auto=format&fit=crop&w=900&q=80',
        featured: true,
      },
      { name: 'Mezgit Tava', price: '320', unit: '₺', desc: 'İri taneli galeta, bütün tava.', tags: ['tava'] },
      { name: 'Barbun Tava',  price: '420', unit: '₺', desc: 'Küçük barbunyalar, mısır unu.',  tags: ['tava'] },
    ],
  },
  {
    id: 'ekstra',
    title: 'Yanlar',
    subtitle: 'Tabağın yanına, paylaşmalık — sabit fiyat',
    items: [
  ...
  },
  {
    id: 'tatlilar',
    title: 'Tatlılar',
    subtitle: 'Ev yapımı, hafif bir kapanış — sabit fiyat',
    items: [
  ...
  },
  {
    ...
    subtitle: 'Burası alkolsüz bir ev — seçeneklerimiz geniş, sabit fiyat',
    items: [
